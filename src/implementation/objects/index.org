...
class TestUser(TestCase):
    ...
    def test_user_creation(self):
        ...
        self.assertEqual(user.name, 'Sravanthi')
        self.assertEqual(user.email, 'sravanthimodepu@vlabs.ac.in')
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_user_get_email(self):
        ...
        user = User(name=Name('Sravanthi'), email=Email('sravanthimodepu@vlabs.ac.in'), role=Role.admin)
        self.assertEqual(user.get_email(), 'sravanthimodepu@vlabs.ac.in')
#+END_SRC
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_user_get_name(self):
        ...
        user = User(name=Name('Sravanthi'), email=Email('sravanthimodepu@vlabs.ac.in'), role=Role.admin)
        self.assertEqual(user.get_name(), 'Sravanthi')
#+END_SRC
